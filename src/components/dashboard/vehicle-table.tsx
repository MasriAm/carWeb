        ...
        <Table>
          <TableHeader>
            <TableRow className="border-line hover:bg-surface">
              ...
              <TableHead className="text-ink-3">Year</TableHead>
              <TableHead className="text-ink-3">Status</TableHead>
              <TableHead className="text-ink-3">Saves</TableHead>
          ...
          <TableBody>
            {vehicles.map((v) => (
              <TableRow key={v.id} className="border-line hover:bg-surface-2/50">
                ...
                <TableCell className="text-ink-3">{v.productionYear}</TableCell>
                <TableCell>
                  <Badge
                    variant="secondary"
                    className={
                ...
                <TableCell className="text-ink-3">{v._count.savedBy}</TableCell>
